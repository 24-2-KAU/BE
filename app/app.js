...
// CORS 설정
const corsOptions = {
  origin: ['http://localhost:4000', '172.31.8.27:4000', 'https://ad-influencer.com', 'http://127.0.0.1:5500', 'http://localhost:3000'],
...
const io = new Server(server, {
  cors: {
    origin: ['http://localhost:4000', '172.31.8.27:4000', 'https://ad-influencer.com','http://127.0.0.1:5500', 'http://localhost:3000'], // 필요한 도메인 추가
    methods: ['GET', 'POST', 'PUT', 'DELETE'],
    credentials: true
  }
});
